package com.newgonzo.web.css.properties.css3.transitions
{
	...
	public class TransitionShorthand extends PropertyManager implements IShorthandManager
	{
		protected static const LONGHAND_PROPERTIES:Array =
		[
			TransitionProperties.TRANSITION_PROPERTY,
			TransitionProperties.TRANSITION_DURATION,
			TransitionProperties.TRANSITION_TIMING_FUNCTION,
			TransitionProperties.TRANSITION_DELAY
		];
		
		public function TransitionShorthand()
		{
			super(TransitionProperties.TRANSITION);
		}
